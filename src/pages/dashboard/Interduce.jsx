            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-12 col-md-9 col-lg-8 mt-5">
                        <div className="col-lg-12 bg-light p-3">
                            ...
                            <div
                                className={`d-flex justify-content-center mt-3 ${
                                    fetchData.total_result !== 0 ? "d-none" : ""
                                }`}
                            >
                            ...
                            >
                                ...
                                <tbody>
                                    {fetchData?.result?.map((person, index) => (
                                        <tr key={index}>
                                            <td>{index}</td>
                                            <td>
                                                {person.firstname +
                        ...
                        <div className="col-lg-12 bg-light p-3 mt-3 d-none">
                            <p className="h3">درامد من</p>
